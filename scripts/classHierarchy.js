...
class SingleParagraphArticle {
    ...
    turnIntoHTML() {
        $( "main" ).append('<article class="1p-articles kb-articles" id="art-'+articleCounter+'"><h2>'+this.title+'</h2><p class="kb-text">'+this.text+'</p><p><a href="#art-'+(articleCounter+1)+'">Next Article</a></p></article>');
...
class DoubleParagraphArticle extends SingleParagraphArticle {
    ...
    // function to turn this article instance into HTML
    turnIntoHTML() {
        $( "main" ).append('<article class="2p-articles kb-articles" id="art-'+articleCounter+'"><h2>'+this.title+'</h2><p class="kb-text">'+this.text+'</p><p class="kb-text">'+this.text2+'</p><p><a href="#art-'+(articleCounter+1)+'">Next Article</a></p></article>');
        // add this article to the nav menu on top
        $( "#nav-menu-kb" ).append('<a href="#art-'+articleCounter+'">'+this.title+'</a>'); 
    }
}
...
class TripleParagraphArticle extends DoubleParagraphArticle {
    ...
    // function to turn this article instance into HTML
    turnIntoHTML() {
        $( "main" ).append('<article class="3p-articles kb-articles" id="art-'+articleCounter+'"><h2>'+this.title+'</h2><p class="kb-text">'+this.text+'</p><p class="kb-text">'+this.text2+'</p><p class="kb-text">'+this.text3+'</p><p><a href="#art-'+(articleCounter+1)+'">Next Article</a></p></article>');
        // add this article to the nav menu on top
        $( "#nav-menu-kb" ).append('<a href="#art-'+articleCounter+'">'+this.title+'</a>'); 
    }
}
